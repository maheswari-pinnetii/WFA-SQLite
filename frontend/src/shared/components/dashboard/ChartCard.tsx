...
export const ChartCard: React.FC<ChartCardProps> = ({
  ...
  return (
    <section
      className="glass-panel p-5 rounded-xl border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 shadow-sm flex flex-col relative w-full h-full"
      style={{ minHeight }}
      aria-busy={isLoading}
    >
      ...
      <div className="flex-1 flex flex-col relative min-h-[200px] w-full">
        {isLoading && (
