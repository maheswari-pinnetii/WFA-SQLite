...
export const MAIN_NAVIGATION: NavigationItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'analytics.learning', label: 'Learning & Dev', path: '/analytics/learning', roles: HR_ADMIN_ROLES },
      { id: 'analytics.recruitment', label: 'Recruitment', path: '/analytics/recruitment', roles: HR_ADMIN_ROLES },
      { id: 'analytics.placement', label: 'Placement', path: '/analytics/placement', roles: HR_ADMIN_ROLES },
      { id: 'analytics.demand', label: 'Demand Forecast', path: '/analytics/demand-forecasting' },
      { id: 'analytics.planning', label: 'Workforce Planning', path: '/analytics/workforce-planning' },
