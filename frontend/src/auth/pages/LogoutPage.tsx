...
export const LogoutPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 sm:p-6 bg-slate-50 dark:bg-[#0B1120] text-slate-900 dark:text-slate-100 font-sans transition-colors duration-300 relative overflow-hidden">
      ...
      {/* Background Glow */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-emerald-500/10 dark:bg-emerald-600/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="w-full max-w-[420px] mx-auto space-y-6 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 rounded-3xl shadow-xl dark:shadow-2xl shadow-slate-900/10 relative z-10 text-center">
        ...
        <div className="flex justify-center pb-1">
          <div className="p-2 rounded-2xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-100 dark:border-emerald-500/20 shadow-sm">
            <StacklyLogo size={42} showText={true} />
          </div>
        </div>

        {/* Icon Badge */}
        <div className="w-16 h-16 bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 rounded-2xl border border-emerald-100 dark:border-emerald-500/20 flex items-center justify-center mx-auto shadow-md">
          <LogOut size={30} />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 max-w-xs mx-auto leading-relaxed font-medium">
            Your active session at <span className="font-mono text-emerald-600 dark:text-emerald-400 font-bold">@thestackly.com</span> has been securely terminated and access tokens cleared.
          </p>
        </div>
