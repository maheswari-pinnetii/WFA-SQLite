/**
 * Authentication Flow Types & Payload Interfaces
 * Supporting Standard Email/Password & Passwordless (WebAuthn/Passkey) Auth Flows
 */
...
// ----------------------------------------------------------------------
// WebAuthn / Passkey JSON Serialization Types
// ----------------------------------------------------------------------
