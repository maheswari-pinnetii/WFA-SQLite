  ...
  const fetchDashboard = useCallback(async () => {
    ...
    try {
      ...
      if (res && res.kpis) {
        ...
        // Data returned but kpis missing — use what we have
        setData(res);
        setError('Some metrics could not be loaded. Showing available data.');
      } else {
        setError('Could not reach the server. Showing estimated values.');
      }
    } catch (err: any) {
