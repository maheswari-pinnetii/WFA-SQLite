...
import { Shield, Settings, Bell, Server } from 'lucide-react';
...
export const AdminProfile: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto animate-fadeIn pb-24">
      <ProfileHeader title="Admin Profile" subtitle="Manage your credentials, system access, and notifications" />

      <div className="glass-panel p-6 md:p-8 space-y-6">
        {/* Tab Navigation */}
        <div className="flex flex-wrap gap-4 border-b border-[var(--border-color)]">
          {[
            { id: 'system', label: 'System Access', icon: <Server size={16} /> },
        ...
        {activeTab === 'system' && (
          <div className="p-6 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-center">
            ...
            <h3 className="font-bold text-lg text-emerald-500">Full System Access</h3>
            <p className="text-xs text-slate-400 mt-1">You have administrative privileges over all organization settings.</p>
          </div>
        )}
