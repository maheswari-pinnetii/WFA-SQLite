  ...
  return (
    <div className="auth-page-wrapper">
      ...
      <main className="auth-single-container" id="auth-flow-main">
        <h1 className="sr-only" style={{ position: 'absolute', width: '1px', height: '1px', padding: '0', margin: '-1px', overflow: 'hidden', clip: 'rect(0, 0, 0, 0)', whiteSpace: 'nowrap', border: '0' }}>Sign in to Stackly</h1>
        {showPasskey ? (
