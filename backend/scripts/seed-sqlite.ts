...
export const seedSqlite = async () => {
  ...
  const transaction = db.transaction(() => {
    ...
    const coreUsers = [
      ...
      ['usr-exec-01', 'Rachel Zane', 'executive@thestackly.com', passHash, 'EXECUTIVE', null, null, null, null, 5, 'ACTIVE', JSON.stringify(['REPORT_VIEW_ALL', 'DASHBOARD_VIEW_ALL', 'EMPLOYEE_VIEW_ALL', 'PERFORMANCE_VIEW_ALL']), 1, ORGANIZATION_ID, ORGANIZATION_ID, nowStr, nowStr]
    ];
