...
export const env = {
  ...
  RATE_LIMIT_GLOBAL_MAX: parseInt(process.env.RATE_LIMIT_GLOBAL_MAX || '2000', 10),
  ...
  RATE_LIMIT_SIGNUP_MAX: parseInt(process.env.RATE_LIMIT_SIGNUP_MAX || '5', 10),
  ...
  RATE_LIMIT_PUBLIC_MAX: parseInt(process.env.RATE_LIMIT_PUBLIC_MAX || '120', 10),
  RATE_LIMIT_PUBLIC_WINDOW_MS: parseInt(process.env.RATE_LIMIT_PUBLIC_WINDOW_MS || '60000', 10),
  RATE_LIMIT_AUTHENTICATED_MAX: parseInt(process.env.RATE_LIMIT_AUTHENTICATED_MAX || '2500', 10),
